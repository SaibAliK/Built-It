...
class SubscriptionController extends Controller
{
    ...
    public function __construct(SubscriptionPackageRepository $subscriptionPackageRepository)
    {
        ...
        $this->breadcrumbs['javascript:{};'] = ['icon' => 'fa fa-fw fa-money', 'title' => 'Manage Subscription Packages'];
    ...
    public function edit($id)
    {
        ...
        $this->breadcrumbs[route('admin.dashboard.subscriptions.index')] = ['icon' => 'fa fa-fw fa-building', 'title' => 'Subscription Packages'];
