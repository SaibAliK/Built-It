 ...
 * NOT_FOUND_IMAGE = image to display when given url image is not found. This is best used in timthumb-config.php
 */

if (!defined('NOT_FOUND_IMAGE')) {
    if (strpos(strtolower($_SERVER['DOCUMENT_ROOT']), 'Xampp')) {
        if ($_SERVER['DOCUMENT_ROOT'] == 'C:/xampp-8.0/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'C:/xampp8.0.12/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'D:/Xampp Projects') {
            define('NOT_FOUND_IMAGE', $_SERVER['DOCUMENT_ROOT'] . '/build-it-laravel/public/images/default-image.jpg');
        } else {
            define('NOT_FOUND_IMAGE', 'D:\Xampp Projects\build-it-laravel\public\images\default-image.jpg');
        }
    } else {
        define('NOT_FOUND_IMAGE', 'https://alpha3.mytechnology.ae/buildit/images/default-image.jpg');
    }
}
...
if (!defined('ERROR_IMAGE')) {
    if (strpos(strtolower($_SERVER['DOCUMENT_ROOT']), 'Xampp')) {
        if ($_SERVER['DOCUMENT_ROOT'] == 'C:/xampp-8.0/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'C:/xampp8.0.12/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'D:/Xampp Projects') {
            define('ERROR_IMAGE', $_SERVER['DOCUMENT_ROOT'] . '/build-it-laravel/public/images/default-image.jpg');
        } else {
            define('ERROR_IMAGE', 'D:\Xampp Projects\build-it-laravel\public\images\default-image.jpg');
        }
    } else {
        define('ERROR_IMAGE', 'https://alpha3.mytechnology.ae/buildit/images/default-image.jpg');
    }
}
...
if (!defined('LOCAL_FILE_BASE_DIRECTORY')) {
    if (strpos(strtolower($_SERVER['DOCUMENT_ROOT']), 'Xampp')) {
        if ($_SERVER['DOCUMENT_ROOT'] == 'C:/xampp-8.0/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'C:/xampp8.0.12/htdocs' || $_SERVER['DOCUMENT_ROOT'] == 'D:/Xampp Projects') {
            define('LOCAL_FILE_BASE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'] . '\build-it-laravel\public');
        } else {
            define('LOCAL_FILE_BASE_DIRECTORY', 'D:/Xampp Projects/build-it-laravel/public');
        }
    } else {
