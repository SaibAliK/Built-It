        ...
        <tr>
            <td align="center">
                <table width="90%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td class="content" valign="top" align="left"
                            style="font-size:24px;font-weight: 500;color:#333;line-height:32px; padding-left:30px;padding-right:30px">{!! $receiver_name !!}
                            Left a Message
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-left:30px;padding-right:30px">
                            <table width="100%" cellpadding="12" cellspacing="0" border="0"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $receiver_name !!}</td>
                                </tr>
                                <tr>
                                    <td valign="center" align="left"
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $receiver_email !!}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2" valign="center" align="left"
                                        style="padding-left:15px;padding-right:15px;border-width:1px;border-color:#efefef;border-style:solid">{!! $message_text !!}</td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
