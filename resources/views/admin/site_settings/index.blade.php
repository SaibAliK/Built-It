            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Site Settings
                        <small>
                            Here You Can Add, Edit Settings
                        </small>
                    </h3>
                </div>
            </div>
                    ...
                    <li class="m-portlet__nav-item">
                        <div class="dropdown show">
                            ...
                            <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="dropdownMenuButton" x-placement="bottom-end" style="position: absolute; transform: translate3d(-9px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
                                <a class="dropdown-item" href="{!! route('admin.dashboard.site-settings.edit', 0) !!}">
                                    <i class="fa fa-plus"></i>
                                    Edit values
                                </a>
                                <a class="dropdown-item" href="{!! route('admin.dashboard.site-settings.table.values') !!}">
                                    <i class="fa fa-plus"></i>
